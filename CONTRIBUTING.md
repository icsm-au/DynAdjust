...
If you plan to make changes to the code base, please ensure you have read the [building from source instructions](https://github.com/icsm-au/DynAdjust#building-from-source) and have obtained all the essential prerequisites.
